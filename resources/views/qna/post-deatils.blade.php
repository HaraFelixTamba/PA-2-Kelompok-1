                        ...
                        <div class="post-details-info1982">
                            <div class="post-details-info1982">
                                    @if ($ask->jawaban->count() === 0)
                                        <div>
                                            <h4 class="arah">Tidak ada jawaban untuk pertanyaan ini.</h4>
                                        </div>
                                    @else
                                        @php
                                        ...
                                        @foreach ($pinnedJawaban->concat($otherJawaban) as $jawaban)
                                            ...
                                            @if ($jawaban->pinned)
                                                ...
                                                <form action="/qna7/{{ $jawaban->id }}" method="post">
                                                    ...
                                                    @php
                                                    $totalVote = $jawaban->vote_up - $jawaban->vote_down;
                                                @endphp
                                    ...
                                    <form action="/qna/{{ $ask->id }}" method="post">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="post9320-box">
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-primary location">Post Pertanyaan</button>
                                            </div>
                                        </div>
                                    </form>
                                @else
                                    <div class="col-md-12">
                                        ...
                                        <hr>
                                        <div class="post9320-box">
                                            <h4>Sudah terdapat jawaban untuk pertanyaan ini.</h4>
                                        </div>
                                    </div>
                                @endif
                            @endif
