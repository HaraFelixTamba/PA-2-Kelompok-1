    ...
    public function voteJawaban(Request $request, Jawaban $jawaban)
{
    ...
    // Menghitung jumlah vote berdasarkan vote up dan vote down pada setiap jawaban
    $totalVote = $jawaban->vote_up - $jawaban->vote_down;

    // Menyimpan jumlah vote ke variabel session
    session()->flash('totalVote', $totalVote);
